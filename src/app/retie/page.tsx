      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-8 sm:p-12 shadow-sm">
          ...
          <div className="mt-8 space-y-4 text-sm text-stone-700 leading-relaxed">
            <p>
              Estamos documentando aquí el detalle de cumplimiento del
              Reglamento Técnico de Instalaciones Eléctricas (RETIE) aplicable
              a los equipos e instalaciones de {siteName}. Esta página se
              actualizará con las certificaciones y fichas correspondientes
              tan pronto estén disponibles para publicación.
            </p>
            <p>
              Para consultar la documentación de cumplimiento de un equipo o
              proyecto específico, contáctanos directamente:
            </p>
